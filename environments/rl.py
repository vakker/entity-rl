...
@PlaygroundRegister.register('spg_endgoal_singleroom')
...
@PlaygroundRegister.register('spg_endgoal_6rooms')
class Endgoal9Rooms(ConnectedRooms2D):

    def __init__(self):

        super().__init__(size = (600, 400), n_rooms=(3,2), wall_type='colorful')

        # Starting area of the agent
        area_start = PositionAreaSampler(center=(300, 200), area_shape='rectangle', width_length=(600, 400))
        self.agent_starting_area = area_start
...
@PlaygroundRegister.register('spg_dispenser_2rooms')
