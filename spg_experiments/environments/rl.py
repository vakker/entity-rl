...
from simple_playgrounds.playgrounds import PlaygroundRegister, scene_elements
from simple_playgrounds.playgrounds.empty import (ConnectedRooms2D, LinearRooms,
                                                  SingleRoom)
...
class EndgoalRoomCue(SingleRoom):
    def __init__(self):
        ...
        # Obstacles
        obstacle_1 = scene_elements.Basic((60, 30, 0.34), default_config_key='pentagon')
        self.add_scene_element(obstacle_1)

        obstacle_2 = scene_elements.Basic((130, 150, 1.7), default_config_key='rectangle')
        self.add_scene_element(obstacle_2)

        obstacle_3 = scene_elements.Basic((40, 140, 0.4), default_config_key='square')
        self.add_scene_element(obstacle_3)

        obstacle_4 = scene_elements.Basic((160, 60, 0),
    ...
    def set_goal(self):
        ...
        self.cue = scene_elements.Basic((100, 100, 0),
        ...
        self.goal = scene_elements.GoalZone(loc, reward=10, is_temporary_entity=True)
        self.add_scene_element(self.goal)

        for i in range(4):
            if i != index_goal:
                loc = self.goal_locations[i]
                other_goal = scene_elements.DeathZone(loc,
                                                      reward=-5,
                                                      is_temporary_entity=True)
...
class Endgoal9Rooms(ConnectedRooms2D):
    def __init__(self):
        ...
        invisible_endzone = scene_elements.GoalZone((20, 20, 0), reward=10)
...
class DispenserEnv(ConnectedRooms2D):
    ...
    def assign_areas(self):
        ...
        area_start = PositionAreaSampler(center=area_start_center,
                                         area_shape='rectangle',
        ...
        self.area_prod = PositionAreaSampler(center=prod_center,
                                             area_shape='rectangle',
                                             width_length=prod_shape)
        self.area_disp = PositionAreaSampler(center=dispenser_center,
                                             area_shape='rectangle',
                                             width_length=dispenser_shape)

    def place_scene_elements(self):

        dispenser = scene_elements.Dispenser(self.area_disp,
                                             production_area=self.area_prod,
                                             entity_produced=scene_elements.Candy,
                                             radius=10,
                                             is_temporary_entity=True,
...
# class scene_elements.CoinMaster(ConnectedRooms2D):
#
#     def __init__(self):
#
...
#         self.assign_areas()
#
#         self.field = scene_elements.Field(scene_elements.Coin, self.area_prod, limit=5, total_limit=1000,
...
class CoinMaster(SingleRoom):
    def __init__(self):
        ...
        self.field = scene_elements.Field(scene_elements.Coin,
                                          self.area_prod,
                                          limit=5,
                                          total_limit=1000,
        ...
        self.vending_machine = scene_elements.VendingMachine(self.area_vm,
                                                             allow_overlapping=False,
                                                             reward=1)
        self.add_scene_element(self.vending_machine)
    ...
    def assign_areas(self):
        ...
        self.area_prod = PositionAreaSampler(center=prod_center,
                                             area_shape='rectangle',
                                             width_length=[80, 80])
        self.area_vm = PositionAreaSampler(center=vm_center,
                                           area_shape='rectangle',
                                           width_length=[80, 80])
